...
module_name=SGR
CUDA_VISIBLE_DEVICES=$gpu python train.py --data_name $data_name --num_epochs 20 --lr_update 10 --module_name $module_name --loss $loss --log_step 200 --data_path ../SCAN/data/data --vocab_path ../SCAN/data/vocab --model_name $model_name --logger_name $logger_name --noise_rate $noise_rate --margin $margin --tau $tau --ratio $ratio
