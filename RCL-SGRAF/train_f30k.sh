...
module_name=SAF
CUDA_VISIBLE_DEVICES=$gpu python train.py --data_name $data_name --num_epochs $num_epochs --loss $loss --lr_update $lr_update --learning_rate $lr --module_name $module_name --log_step 200 --data_path ./data --vocab_path ./vocab --model_name $model_name --logger_name $logger_name --noise_rate $noise_rate --margin $margin --tau $tau --batch_size $batch_size
